...
-   **史都华德([v1](../chars/char_210_stward.md))**：A4小组成员，安赛尔的队友，安赛尔负责为他进行矿石病检查和换药。
...
-   **狮蝎([v1](../chars/char_215_mantic.md))**：安赛尔参与了对刚来到罗德岛的她进行初步关怀和沟通，试图建立信任。
-   **泡普卡([v1](../chars/char_281_popka.md))**：安赛尔与凯尔希一起将她带回罗德岛，安赛尔关心她，并承诺帮助她寻找家人。
-   **白面鸮([v1](../chars/char_128_plosis.md))**：安赛尔曾向她倾诉自己的过去和加入罗德岛的原因。
-   **芬([v1](../chars/char_123_fang.md))**：安赛尔在处理干员病假等工作事务时会与她联系。
