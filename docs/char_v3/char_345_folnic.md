...
-   **灰喉([v1](../chars/char_367_swllow.md),[v2](char_367_swllow.md))**：与亚叶一同前往沃伦姆德的罗德岛干员。她在沃伦姆德的行动中曾劝说亚叶保持理性，并在事后与亚叶一同反思。
...
-   **毕德曼([v1](../chars/extended_char_bi_de_man.md),[v2](extended_char_bi_de_man.md))**：沃伦姆德事件中的天灾信使，亚叶最初认为他是导致安托遇难的凶手，并想为安托复仇，但后来得知他已死于暴乱。
-   **塞弗林**：沃伦姆德的宪兵长官。亚叶曾试图向他打听安托的下落，但认为他有所隐瞒。
-   **塔佳娜([v1](../chars/extended_char_ta_jia_na.md),[v2](extended_char_ta_jia_na.md))**：沃伦姆德当地人，带领亚叶前往安托的临时医疗点，让她确认了安托遇难的事实。
-   **絮雨([v1](../chars/char_436_whispr.md),[v2](char_436_whispr.md))**：罗德岛医疗部医师，曾私下为傀影处理伤口，被亚叶提及。
