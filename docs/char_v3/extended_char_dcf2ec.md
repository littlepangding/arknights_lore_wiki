...
-   **沃里克伯爵([v1](../chars/extended_char_wo_li_ke_bo_jue.md))**：塔拉贵族，爱布拉娜曾经的学生。爱布拉娜在其死后接管了他的势力，并将其转化为深池，认为伯爵的野心过于狭隘空想。
-   **阿赫茉妮**：深池成员。通过她的视角展现了爱布拉娜对深池的操控和她与苇草关系的复杂性。
-   **校官([v1](../chars/extended_char_xiao_guan.md))**：深池成员，爱布拉娜的心腹之一，负责执行爱布拉娜的指令，包括营救苇草。
