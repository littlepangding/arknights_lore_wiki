...
## 相关角色
-   **塞尔蒙([v1](../chars/extended_char_sai_er_meng.md),[v2](extended_char_sai_er_meng.md))**：同行的塔拉流民，性格强硬，倾向于暴力和加入深池。维恩多次与她争吵，反对她的路线，但也曾得到她的提示参与逃脱。塞尔蒙曾打劫过维恩，但最终是为了给哥哥寻找靴子。
...
-   **莫兰([v1](../chars/extended_char_mo_lan.md),[v2](extended_char_mo_lan.md))**：同行的塔拉流民，维恩的朋友，两人会用口哨和歌声互相安慰。
