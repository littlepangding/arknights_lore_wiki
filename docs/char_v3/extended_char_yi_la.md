...
## 相关角色
-   **加勒斯([v1](../chars/extended_char_jia_lei_si.md),[v2](extended_char_jia_lei_si.md))**：依拉在荒地中的同伴，曾是乌萨斯士兵。两人一同寻找锈锤组织，并互相扶持通过了锈锤的生存考验。在面对乌萨斯军队追击时，依拉坚定的态度最终说服了原本倾向逃跑的加勒斯，决定留下来战斗。
