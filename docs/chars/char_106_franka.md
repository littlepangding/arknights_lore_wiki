...
-   **杏仁([v1](char_4105_almond.md))**：曾是黑钢成员，后加入罗德岛。与芙兰卡一起执行过任务，期间雷蛇不在。她在“驻足”任务中注意到芙兰卡在任务中展现出的异常沉稳可靠的一面，与平时感觉不同，并将这一观察告诉了雷蛇，侧面展现了芙兰卡的能力。她认为芙兰卡和雷蛇的故事很有趣，甚至想用来赚钱。
...
-   **香草([v1](char_240_wyvern.md))**：罗德岛干员，也来自瓦伊凡，曾是黑钢成员。她在罗德岛与芙兰卡一起执行过任务，也向雷蛇讲述过瓦伊凡部族的生活。她在“尚待”中告诉杰西卡芙兰卡曾向她详细询问过瓦伊凡部族情况。她向芙兰卡请教如何与雷蛇相处，得到了带有戏弄成分的建议。在“源石虫与啤酒花”事件后，芙兰卡安慰了任务中情绪崩溃的香草，并收养了香草救下的小源石虫，将其命名“圆圆”。
