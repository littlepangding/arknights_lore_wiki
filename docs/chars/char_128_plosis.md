...
## 相关角色
-   **赫默([v1](char_108_silent.md),[v2](../char_v3/char_108_silent.md))**：白面鸮在莱茵生命时期的引荐人和长官，现于罗德岛同在医疗部门共事，是白面鸮重要的朋友和医生，非常关心白面鸮的健康问题和梦境困扰，多次建议她寻求罗德岛其他专家的帮助。在“绿野幻梦”中，赫默与格雷伊一同前往359基地营救，为昏迷中的白面鸮进行治疗，并在实验失控后与白面鸮并肩抵挡怪物，对白面鸮的安危极为紧张。白面鸮也极为珍视赫默，将其登记为朋友。
-   **伊芙利特([v1](char_134_ifrit.md),[v2](../char_v3/char_134_ifrit.md))**：白面鸮协助监护的矿石病患者，与白面鸮关系亲近，能敏锐地察觉白面鸮细微的情绪变化，喜欢对白面鸮的发型进行恶作剧。在“深暗之梦”中，白面鸮记录了伊芙利特对自己的关心。
...
-   **梅尔([v1](char_242_otter.md),[v2](../char_v3/char_242_otter.md))**：罗德岛工程干员，白面鸮的朋友。曾帮助白面鸮检查九号装置的运作情况，对其复杂性和潜在风险感到担忧，同样建议白面鸮寻求可露希尔的专业帮助。在“深暗之梦”中，她与白面鸮讨论了九号装置的问题，并与伊芙利特一同关心白面鸮。
-   **博士([v2](../char_v3/extended_char_bo_shi.md))**：罗德岛的指挥者。白面鸮对其好感度已达满值，在语音中会向其汇报工作或开玩笑。在“绿野幻梦”活动中，白面鸮被绑架的经历及其九号装置接收到的信息被博士利用，成为了揭示359基地实验真相、迫使克丽斯腾介入并阻止斐尔迪南计划的关键证据。博士对此表示感谢，并依赖白面鸮传递信息。
...
-   **塞雷娅([v1](char_202_demkni.md),[v2](../char_v3/char_202_demkni.md))**：前莱茵生命防卫科主任。白面鸮档案中提到涉及她的莱茵生命内部资料是加密文件，从白面鸮个人情感出发也不建议博士查询，暗示其与莱茵生命“炎魔事件”及相关人员的复杂关系。在“绿野幻梦”中，塞雷娅与白面鸮同为罗德岛及莱茵相关方卷入事件，她向博士提供缪尔赛思失踪信息，博士则利用白面鸮获得基地内部信息以寻求她的帮助。
-   **埃琳娜·乌比卡([v1](extended_char_7bc2a3.md))**：莱茵生命研究员，罗德岛合作干员，白面鸮的朋友。在“绿野幻梦”活动中与白面鸮一同被拓荒者绑架到359基地，共同经历了实验失控危机。她对白面鸮的身体状况极为担忧，并试图记录实验数据和保护白面鸮。
...
-   **格雷伊([v1](char_253_greyy.md))**：罗德岛工程干员。在“绿野幻梦”中与赫默一同前往359基地，与白面鸮、赫默、多萝西一同抵挡失控的造物。白面鸮在危机中对他提供了源石技艺支援，两人在共同面对怪物时进行了交流和协作。
-   **克丽斯腾·莱特([v1](extended_char_336509.md),[v2](../char_v3/extended_char_336509.md))**：莱茵生命总辖，九号装置项目的批准者之一。在“绿野幻梦”中，博士利用白面鸮接收到的关于359基地实验和受试者真实意愿的信息作为证据，迫使克丽斯腾介入359基地事件，最终阻止了斐尔迪南的计划。
-   **桑尼·罗马诺([v1](extended_char_36ed71.md))**：359基地拓荒者领队。在“绿野幻梦”中绑架了白面鸮和埃琳娜。白面鸮在病发昏迷中通过九号装置感受到的受试者集体意识信息，包括桑尼本人（作为受试者之一）的意愿，间接影响了赫默和桑尼之间的对话，也最终通过博士影响了事件走向。他在危机中也关心白面鸮的安危。
-   **斐尔迪南·克鲁尼([v1](extended_char_0157f6.md))**：莱茵生命能量科主任。在“绿野幻梦”中是359基地实验的幕后主导者。白面鸮通过九号装置接收到的受试者意识信息，最终被博士用来揭露其计划并使其失败。斐尔迪南在事件中试图阻止罗德岛和塞雷娅获取信息。
-   **缪尔赛思([v1](char_249_mlyss.md),[v2](../char_v3/char_249_mlyss.md))**：莱茵生命生态科主任。在“绿野幻梦”中，她的失踪是事件开端之一。她通过信息暗示了359基地与斐尔迪南有关，并与塞雷娅、博士会合。她信任赫默和白面鸮的能力。
-   **霍尔海雅([v1](char_4027_heyak.md),[v2](../char_v3/char_4027_heyak.md))**：神秘黎博利，在“绿野幻梦”中作为观察者和搅局者出现。她与斐尔迪南和克丽斯腾都有联系，试图获取信息并推动事态发展。白面鸮作为事件的关键信息载体，间接被她利用。
-   **帕尔维斯([v1](extended_char_pa_er_wei_si.md),[v2](../char_v3/extended_char_pa_er_wei_si.md))**：莱茵生命结构科主任。在“绿野幻梦”中，他与斐尔迪南的对话提及了赫默、炎魔实验等往事，并提供了帮助（实为制衡）。与白面鸮直接互动不多，但其言行体现了莱茵内部环境和与白面鸮经历相关的背景。
## 详细介绍
