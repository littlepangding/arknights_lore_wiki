...
-   **洛洛([v1](char_4040_rockr.md))**：火神在“锻造”活动中提及的另一位罗德岛干员，来自维多利亚，坚持使用自己手工制作的日用品。火神用她作为例子，与角峰讨论了关于“根”和坚持传统的意义。
...
-   **米格鲁([v1](char_122_beagle.md))**：在“锻造”中提到火神修复过她的盾牌。
...
-   **夜刀([v1](char_502_nblade.md))**：在“授刀”活动中，夜刀将一把包含师傅刀碎片、意义非凡的旧刀交给火神处理。火神从专业角度评估了刀的状况，指出其强度已不足以用于高强度战斗，提供熔铸建议，并最终执行了熔铸，见证了夜刀赋予旧刀新意义（用于罗德岛新人训练传承技艺）的决定，并表示自己可以做到。
