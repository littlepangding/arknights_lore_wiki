...
-   **斑点([v1](char_284_spot.md))**：在叙拉古任务中与THRM-EX组队。最初觉得THRM-EX聒噪，但在雨中曾靠在THRM-EX身上烘干毛发。对THRM-EX突然失灵的表现感到无奈。有时会将THRM-EX与月见夜进行比较。
-   **守林人([v1](char_158_milu.md))**：在叙拉古任务中与THRM-EX组队。沉默寡言，但观察敏锐，判断出袭击是有组织有目标的。在THRM-EX暂时失能时，准备独自应对敌人，并注意到了博士对THRM-EX恢复时机的精准计算。
...
-   **Lancet-2([v1](char_285_medic2.md))**：可露希尔提到这是罗德岛的机器人之一，但没有发生像THRM-EX一样的自我进化。
-   **Castle-3([v1](char_286_cast3.md))**：可露希尔提到这是罗德岛的机器人之一，但没有发生像THRM-EX一样的自我进化。
-   **月见夜([v1](char_283_midn.md))**：斑点曾开玩笑怀疑THRM-EX是月见夜的亲兄弟，可能指两人都很健谈。
