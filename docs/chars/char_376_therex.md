...
## 相关角色
-   **可露希尔**：THRM-EX最初的改造者之一，主要负责他的基础参数设定。可露希尔对THRM-EX独特的语言风格感到惊讶，但也认为他能与不善交际的干员良好相处。她发现了THRM-EX的能源异常，并与梅尔一起调查，最终见证了THRM-EX的自我进化，对此感到非常激动。
-   **梅尔**：THRM-EX主要的武器与储能装置改进者。THRM-EX对梅尔的改造尤为赞叹。梅尔与可露希尔一同调查了THRM-EX的能源异常，并发现了其能量输出效率的提升。她对THRM-EX表现出的超越设计的功能和自主意愿的驱使感到极度兴奋，希望能对其进行更多实验记录。
...
-   **煌**：THRM-EX称其为“灼热的伙伴”，能成为自己的好搭档。
-   **斑点**：在叙拉古任务中与THRM-EX组队。最初觉得THRM-EX聒噪，但在雨中曾靠在THRM-EX身上烘干毛发。对THRM-EX突然失灵的表现感到无奈。有时会将THRM-EX与月见夜进行比较。
-   **守林人**：在叙拉古任务中与THRM-EX组队。沉默寡言，但观察敏锐，判断出袭击是有组织有目标的。在THRM-EX暂时失能时，准备独自应对敌人，并注意到了博士对THRM-EX恢复时机的精准计算。
...
-   **阿米娅**：博士受医药公司代表所托，需要向阿米娅转达谢意。
-   **凯尔希**：可露希尔打算向凯尔希询问关于THRM-EX异常的情况。守林人等干员向凯尔希汇报了叙拉古的任务情况。
-   **Lancet-2**：可露希尔提到这是罗德岛的机器人之一，但没有发生像THRM-EX一样的自我进化。
-   **Castle-3**：可露希尔提到这是罗德岛的机器人之一，但没有发生像THRM-EX一样的自我进化。
-   **月见夜**：斑点曾开玩笑怀疑THRM-EX是月见夜的亲兄弟，可能指两人都很健谈。
-   **赫默**：梅尔提到赫默曾说过晚上睡觉会不自觉地想要变出羽毛，暗示她也怕冷，可能是THRM-EX想要温暖的对象之一。
## 详细介绍
...
## 相关活动
-   **炙热冲击！**：THRM-EX的个人剧情活动。活动中，THRM-EX跟随博士等干员前往叙拉古执行交易任务，遭遇黑帮袭击。他在战斗中表现出超预期的能力，并在关键时刻二次爆发。任务结束后，可露希尔和梅尔对他的能源异常进行调查，最终发现他为了给怕冷干员（包括博士）供暖而自主优化了能量输出逻辑，实现了功能的突破和自我进化。
## trivia
