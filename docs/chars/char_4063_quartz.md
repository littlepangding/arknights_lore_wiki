...
-   **刻刀([v1](char_301_cutter.md),[v2](../char_v3/char_301_cutter.md))**：罗德岛干员。石英有时会和刻刀一起学习钻研厨艺。
-   **暴雨([v1](char_304_zebra.md),[v2](../char_v3/char_304_zebra.md))**：罗德岛干员。石英有时会和暴雨一起翻阅最新的连载漫画。
-   **宴([v1](char_337_utage.md),[v2](../char_v3/char_337_utage.md))**：罗德岛干员。石英有时会和宴一起在女生宿舍，宴会向她介绍最新的流行元素。
-   **杰克([v1](char_347_jaksel.md),[v2](../char_v3/char_347_jaksel.md))**：罗德岛干员，日常报告中提及石英的准时。
-   **博士([v2](../char_v3/extended_char_bo_shi.md))**：罗德岛的博士。石英目前效力于罗德岛，经常与博士交流，向博士袒露心声，并在任务中协助博士。石英认为罗德岛是能守护美好事物的组织，来这里是她慎重考虑后的决定。她也为博士准备生日礼物（一块怀表）。
## 详细介绍
