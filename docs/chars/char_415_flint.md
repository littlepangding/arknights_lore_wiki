...
-   **贾维([v1](char_349_chiave.md),[v2](../char_v3/char_349_chiave.md))**：在“合格的战士”活动中，贾维作为支援与燧石和布洛卡一同参与了欺骗萨尔贡密探的行动，负责拖住另一名密探。在行动成功后，他与燧石和布洛卡汇合，得知布洛卡脸上的伤时曾爆笑，并向燧石夸赞她被依娜姆信任。他认为燧石的成长出乎他意料。在“英雄们的叙事诗”活动中，贾维与燧石一同被埃拉托采访，并一同参加了埃拉托的诗篇吟诵会。
...
-   **调香师([v1](char_181_flower.md),[v2](../char_v3/char_181_flower.md))**：罗德岛温室管理人，燧石曾因采摘温室花卉与其管理的花卉发生冲突。调香师也参加了埃拉托的诗篇吟诵会。
-   **AUS**：一支传奇乐队，曾在阿卡胡拉进行过演出，并被部分提亚卡乌人视为“玛维索提亚”的使者，留下的唱片让当地人爱上了摇滚乐。燧石在“密林悍将归来”活动中听到了她们的音乐，觉得“很刺激”，并开始喜欢她们。
-   **迪伦([v1](extended_char_di_lun.md),[v2](../char_v3/extended_char_di_lun.md))**：在“密林悍将归来”活动中，是博士一行乘坐的飞行器驾驶员。飞行器坠毁后，与Lancet-2一起留在特米米部族处守护飞行器。在特米米计划失败后，他与Lancet-2一同回到了罗德岛。迪伦也参加了埃拉托的诗篇吟诵会。
-   **可颂([v1](char_201_moeshd.md),[v2](../char_v3/char_201_moeshd.md))**：在“密林悍将归来”活动中与博士一行一同坠机，后与嘉维尔和博士重逢并一同行动。她也参加了埃拉托的诗篇吟诵会。
-   **宴([v1](char_337_utage.md),[v2](../char_v3/char_337_utage.md))**：在“密林悍将归来”活动中与博士一行一同坠机，后成为一个部族的族长，并与嘉维尔和博士重逢一同行动。她称燧石是“好可爱的女孩子”。她也参加了埃拉托的诗篇吟诵会。
-   **大祭司([v1](extended_char_da_ji_si.md),[v2](../char_v3/extended_char_da_ji_si.md))**：祖玛玛的部族成员，自称活了很久，是建造“巨大的丑东西”的搭档。他向祖玛玛解释传统是可以改变的。他与祖玛玛一同前往了罗德岛。他参加了埃拉托的诗篇吟诵会。
