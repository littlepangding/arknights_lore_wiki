...
-   **酸糖([v1](char_366_acdrop.md),[v2](../char_v3/char_366_acdrop.md))**：罗德岛干员，曾因特克诺的涂鸦被冤枉，特克诺送了她礼物作为补偿。
-   **清流([v1](char_385_finlpp.md),[v2](../char_v3/char_385_finlpp.md))**：罗德岛干员，负责清洁，特克诺替她顶班作为涂鸦的惩罚。
...
-   **米沃什([v1](extended_char_mi_wo_shen.md),[v2](../char_v3/extended_char_mi_wo_shen.md))**：雷内尔的秘书，在水晶箭行动中协助雷内尔处理事务，并与马特奥周旋以实现雷内尔的计划。他忠于雷内尔，但在得知雷内尔的艺术馆爆炸计划后试图阻止并向彩虹小队提供信息（包括炸弹位置和拆除方法）以换取雷内尔的安全。他曾向艾拉透露雷内尔母亲的故事，希望艾拉能帮助雷内尔。事件后选择继续留在雷内尔身边。
-   **马特奥([v1](extended_char_ma_te_ao.md),[v2](../char_v3/extended_char_ma_te_ao.md))**：玻利瓦尔联合政府上尉，企图通过非法手段（包括抢劫罗德岛药物、污蔑艺术社区、制造假恐怖袭击）获取艺术社区地皮并借机盗窃艺术馆展品。特克诺在水晶箭行动中参与了压制他的行动。他在“共舞”活动中试图通过媒体抹黑艺术社区，并组织假借消防检查之名的袭击，导致舞厅和大型木偶被毁。最终在克里斯达尔艺术馆被彩虹小队和社区艺术家制服。
