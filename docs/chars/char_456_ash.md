...
-   **米沃什([v1](extended_char_mi_wo_shen.md),[v2](../char_v3/extended_char_mi_wo_shen.md))**：雷内尔的助手。在水晶箭行动中协助雷内尔，也与艾拉小队互动。他了解雷内尔的计划和情感，并主动帮助艾拉小队排爆以争取雷内尔的生机。他对雷内尔有深厚的感情。
-   **马特奥([v1](extended_char_ma_te_ao.md),[v2](../char_v3/extended_char_ma_te_ao.md))**：玻利瓦尔联合政府派驻多索雷斯的上尉。在水晶箭行动中是主要反派。他策划抢劫药品、袭击社区、在艺术馆制造混乱等事件，目的是获取地皮和艺术品，提升自己的地位。最终被抓住并被公审。
