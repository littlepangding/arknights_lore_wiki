...
-   **龙舌兰([v1](char_486_takila.md),[v2](../char_v3/char_486_takila.md))**：罗德岛干员，在水晶箭行动中与空爆一同运送药品至多索雷斯社区。他曾经在多索雷斯市长坎黛拉手下工作，熟悉当地情况。他追查到被抢药品的位置（雷内尔的仓库）并发现了雷内尔布设的炸弹，后与艾拉小队合作解决了危机，并参与了对雷内尔的处理。
-   **空爆([v1](char_282_catap.md),[v2](../char_v3/char_282_catap.md))**：罗德岛干员，在水晶箭行动中与龙舌兰一同运送药品。她与艾拉小队一同行动，参与了艺术馆的救援和排爆。
