...
## 相关角色
-   **黑角([v1](char_500_noirc.md),[v2](../char_v3/char_500_noirc.md))**：罗德岛A4行动组成员，与夜刀是亲密搭档和可靠的战友。黑角曾在夜刀作为杀手的过去救赎了她，两人一同经历了逃亡。黑角在故事中曾用“另一只鬼”暗喻夜刀，提及她因见不得日光而戴面具。两人在“授刀”、“落叶逐火”和“甲板另一侧”等多个活动中共同行动，互相支持，关系深厚。黑角是夜刀少数会倾诉烦恼的同伴，他也对夜刀的过去和内心状态非常了解和关心。他们在“落叶逐火”中配合默契，共同对抗强大的敌人，并一同经历矿洞爆炸等危机。
-   **巡林者([v1](char_503_rang.md),[v2](../char_v3/char_503_rang.md))**：罗德岛资深干员，与夜刀、黑角关系亲近的老同事。在“授刀”中与夜刀交流罗德岛新人培养和资深干员面临压力的问题，提供建议，并一同打牌放松。
-   **火神([v1](char_163_hpsts.md),[v2](../char_v3/char_163_hpsts.md))**：罗德岛武器工程师。在“授刀”中帮助夜刀处理无法用于高强度战斗的旧刀，倾听她的烦恼，并按照夜刀的决定将旧刀熔铸成新的训练用刀。
...
-   **柏生义冈([v1](extended_char_bai_sheng_yi_gang.md),[v2](../char_v3/extended_char_bai_sheng_yi_gang.md))**：东国露华村的年迈猎人。在“落叶逐火”中，夜刀与他从对立到理解，通过了解他的悲痛（儿子柏生明的死）和执念（独自猎杀火龙为子复仇），最终成功唤醒了他作为猎人守护家园的责任，与他一同对抗兽潮。夜刀向他坦承自己作为杀手的过去和未能保护无辜的悔恨，用自己的经历触动了他，并在最后关头冒险返回救了他，最终赢得了他的尊重和并肩作战。
...
-   **工匠猫([v1](extended_char_gong_jiang_mao.md),[v2](../char_v3/extended_char_gong_jiang_mao.md))**：来自“新大陆”的艾露猫，武器工匠。在“落叶逐火”中与夜刀、黑角和学者猫一同行动。他沉默寡言但行动力极强，能利用找到的素材快速制作实用的道具和装备（异臭球、绳索、甚至眩光手雷和“麒麟衍生武具”）。他对新的素材和工具充满好奇心。他帮助夜刀和黑角适应和使用新的装备，并在关键时刻提供了扭转战局的道具。
...
-   **布洛卡([v1](char_356_broca.md),[v2](../char_v3/char_356_broca.md))**：罗德岛新干员。在“信任的第一步”中，与他失散的资深近卫干员提到因对布洛卡态度不当而受到夜刀训斥。他的经历侧面反映了夜刀作为资深干员的管理风格和对新干员的关心。
-   **近卫干员（信任的第一步）**：在“信任的第一步”中，因对布洛卡态度不当而受到夜刀训斥。他的经历侧面反映了夜刀作为资深干员的管理风格和对新干员的关心，也显示了夜刀在内部具有一定的威严和管理职责。
-   **泷居应([v1](extended_char_long_ju_ying.md),[v2](../char_v3/extended_char_long_ju_ying.md))**：露华村村长，泷居未来的叔叔，柏生明的师父。在“落叶逐火”中，他最初因对村庄经济和秘密的保护而阻挠夜刀的调查和撤离建议。后期揭示了他隐瞒矿场真相、七年前参与屠杀犰爪兽、以及对柏生明牺牲的愧疚。他在天灾来临时，放弃了隐瞒，直面灾难，并与村民们一同抵抗兽潮。最终与柏生义冈并肩作战，解开了多年的误会。
-   **泷居未来([v1](extended_char_long_ju_wei_lai.md),[v2](../char_v3/extended_char_long_ju_wei_lai.md))**：露华村村长泷居应的侄女，一名生态学者。在“落叶逐火”中，她潜入矿场调查源石异常，并提前联系了罗德岛。她向黑角和学者猫揭示了露华村矿场的历史、犰爪兽被屠杀的真相、柏生明的死因以及天灾即将来临的预警。她提供了摧毁矿场的方案。她在村庄混乱时出面引导村民，并在天灾后带领村民重建，展现了对村子未来的思考和努力。她与夜刀没有直接深入的交流，但夜刀了解了她的身份和提供的关键信息。
-   **利藤裕([v1](extended_char_li_teng_yu.md),[v2](../char_v3/extended_char_li_teng_yu.md))**：露华村村民，负责对外交易，贪婪且自私。在“落叶逐火”中，他试图利用夜刀等人对付火龙，后又趁天灾煽动村民制造混乱并私自转移资产。夜刀最终在村民面前直接制服并揭露了他的行为，平息了骚乱。
-   **和也([v1](extended_char_he_ye.md),[v2](../char_v3/extended_char_he_ye.md))**：露华村的幼童。在“落叶逐火”中，最初带领受伤的夜刀和黑角前往柏生义冈的家寻求帮助。他崇拜猎人，在最终兽潮来临时试图挺身而出保护村庄和柏生义冈，短暂吸引了火龙的注意，其勇气得到了夜刀的认可。夜刀在最后救下了他。
## 详细介绍
