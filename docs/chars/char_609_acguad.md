...
-   **莫希([v1](extended_char_mo_xi.md),[v2](../char_v3/extended_char_mo_xi.md))**：在“风雪过境”圣猎仪式上，Sharp及时出现并阻止了莫希对恩希欧迪斯的刺杀行动。
...
-   **哈洛德·克雷加文([v1](extended_char_6367bd.md),[v2](../char_v3/extended_char_6367bd.md))**：Sharp在“银心湖列车”中与维多利亚的子爵哈洛德一同乘坐列车。
## 详细介绍
