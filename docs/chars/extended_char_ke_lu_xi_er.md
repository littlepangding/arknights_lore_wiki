...
-   **雪雉([v1](char_383_snsant.md))**：可露希尔是雪雉在工程和学术上的前辈和导师。她指导雪雉进行研究、撰写论文，并帮助她解决问题。她认可雪雉的努力和天赋，也关心雪雉的生活习惯。
...
-   **波登可([v1](char_258_podego.md))**：疗养庭院的干员。可露希尔负责审批波登可提出的扩建申请，并最终批准了该申请，部分原因是因为波登可的坚持和用心打动了她，以及可露希尔收到了波登可送的花饼和花茶（玩笑）。她也将部分庭院的管理工作交给波登可负责。
-   
## 详细介绍
**
