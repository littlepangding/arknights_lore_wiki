...
-   **贝罗尼村长([v1](../chars/extended_char_bei_luo_ni_cun_zhang.md),[v2](../char_v3/extended_char_bei_luo_ni_cun_zhang.md))**: 作为贝罗尼村的代表，接待罗德岛干员，说明村庄困境，对史尔特尔的帮助表示感谢，并邀请她们留在村庄。
...
-   **莫提([v1](../chars/extended_char_mo_ti.md),[v2](../char_v3/extended_char_mo_ti.md))**: 巫恋的非人形同伴，似乎以情绪或类似物为食，在节日中因接触复杂情绪而感到不适。巫恋用 Arts 和苹果汁等方式对其进行修补，并用故事教导它理解世界。
