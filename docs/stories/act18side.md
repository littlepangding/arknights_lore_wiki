...
-   **格特鲁德([v1](../chars/extended_char_ge_te_lu_de.md),[v2](../char_v3/extended_char_ge_te_lu_de.md))**: 维谢海姆的斯特罗洛伯爵，音乐会赞助人。她操纵尘世之音研究和夕照区事件，目的是利用巫王遗留力量向控制她家族的幕后势力复仇。她心计深沉，冷酷无情，最终在试图完成计划时被别格勒击杀。
-   **别格勒([v1](../chars/extended_char_bie_ge_lei.md),[v2](../char_v3/extended_char_bie_ge_lei.md))**: 夕照区咖啡店主，真实身份是女皇密探。他不动声色地调查格特鲁德和夕照区的异常事件，发现了尘世之音实验室。他代表莱塔尼亚的国家利益行事，最终阻止并击杀了格特鲁德。
